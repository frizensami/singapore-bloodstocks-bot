...
class FirebasePersistence(BasePersistence):
    ...
    def get_bot_data(self):
        print(f"Getting firebase bot data: {self.fb_bot_data.get()}")
        print(f"Getting fb bot data type: {type(self.fb_bot_data.get())}")
        # return defaultdict(dict, self.fb_bot_data.get() or {})
        return self.fb_bot_data.get() or {}
    ...
    def update_user_data(self, user_id, data):
        ...
        self.fb_user_data.child(str(user_id)).update(data or {})

    def update_chat_data(self, chat_id, data):
        print("Updating chat data")
        self.fb_chat_data.child(str(chat_id)).update(data or {})

    def update_bot_data(self, data):
        print(f"Updating bot data: {data}")
